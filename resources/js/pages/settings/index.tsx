        ...
        >
            <div className={`flex flex-col md:flex-row gap-8`} dir={position === 'right' ? 'rtl' : 'ltr'}>
                ...
                <div className="flex-1">
                    ...
                    {(auth.permissions?.includes('manage-brand-settings') || auth.roles?.includes('superadmin')) && (
                    ...
                    {(auth.permissions?.includes('manage-currency-settings') || auth.roles?.includes('superadmin') || auth.roles?.includes('company')) && (
                    ...
                    {(auth.permissions?.includes('manage-email-settings') || auth.roles?.includes('superadmin')) && (
                        <section id="email-settings" ref={emailSettingsRef} className="mb-8">
                            <EmailSettings />
                        </section>
                    )}
                    {/* Email Notification Settings Section */}
                    {(auth.permissions?.includes('manage-email-notifications') || auth.roles?.includes('company')) && (
                    ...
                    {(auth.permissions?.includes('manage-twilio-notifications') || auth.roles?.includes('company')) && (
                    ...
                    {(auth.permissions?.includes('manage-chatgpt-settings') || auth.roles?.includes('superadmin')) && (
